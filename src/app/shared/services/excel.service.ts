...
export class ExcelService {
  ...
  hojaFormularioInicial(workbook: Workbook, headers: any, details: any, textosLargos: any): void {
    ...
    const propiedades = [
      ...
      'IdGrupoCompras', 'IdSujetoLote', 'IdClaseEtiqueta', 'IdFormaEtiqueta', 'TiempoHastaCaducidad', 'IdIndicadorPeriodoPFECaducidad', 'IdIndicadorPeriodoConservacion', 'TiempoCaducidadEnAlmacen',
  ...
  hojaOtros(workbook: Workbook, headers: any, details: any): void {
    ...
    const propiedades: string[] = [
      ...
      'IdMostrarClientes', 'IdVerificacionDisponibilidad', 'OrgVenta', 'IdCanalDistribucion', 'CentroSuministrador', 'NombreComercial', 'DescripcionComercial', 'IdSusceptibleBonificacion'
    ];
  ...
  generateBasicExcel(nameSheet: string, nameFile: string, data: any[], header: string[]) {
    let workbook = new Workbook();
    let worksheet = workbook.addWorksheet(nameSheet);
    ...
    data.forEach(item => {
      ...
      let dataRow = worksheet.addRow(row);
