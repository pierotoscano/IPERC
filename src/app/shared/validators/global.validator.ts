...
export const errorMessagesSolicitudForm: { [key: string]: string } = {
    ...
    IdIndicadorPeriodoConservacion: 'El Campo es Obligatorio.',
    ...
    MPEAN14: 'Ingresar 11111111111111 si el producto no cuenta con EAN14.',// 'El Campo debe tener 14 caracteres.',
    ...
    PartidaArancelaria: 'Ingresar 1111111111 si es producto nacional.',// 'El Campo debe tener entre 1 y 13 caracteres.',
    ...
    IdMarcaMostrarPalmWeb: 'Selecciona 1010-Visible QS en caso se requiera visualizar en otros aplicativos de ventas.', //'El Campo es Obligatorio.',
    ...
    NombreComercial: 'El Campo es Obligatorio.',
    DescripcionComercial: 'El Campo es Obligatorio.'
